...
The migration strategy is divided into six main steps. These steps operationalise the methodology introduced in Chapter~\ref{chap:Chapter3} and provide a common procedure for both case studies:
\begin{enumerate}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.25\textwidth]{ch4/assets/strategy.png}
\decoRule
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{ch4/assets/phases.png}
\decoRule
