...
Table \ref{tab:development_gantt} presents a Gantt-style overview of the
development plan covering the February–July period.
...
\hline
\textbf{Activity / Month} & \textbf{Feb} & \textbf{Mar} & \textbf{Apr} & \textbf{May} & \textbf{Jun} & \textbf{Jul} \\ \hline
System Analysis and Boost Selection      & X &   &   &   &   &   \\ \hline
Architectural Refactoring &   & X &   &   &   &   \\ \hline
Rust Reimplementation     &   &   & X &   &   &   \\ \hline
Bidirectional \gls{FFI} Integration            &   &   &   & X &   &   \\ \hline
Validation and Safety Analysis           &   &   &   &   & X &   \\ \hline
Consolidation and Documentation          &   &   &   &   &   & X \\ \hline
\end{tabular}
