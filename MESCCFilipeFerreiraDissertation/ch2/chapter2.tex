...
As illustrated in Figure \ref{fig:rustpreventions}, approximately 56.9\% of these historical vulnerabilities fall into 
the "Virtually Impossible" category, 
meaning they would be prevented by Rust's strict type system and borrow checker without requiring runtime overhead. 
Conversely, 29.3\% of vulnerabilities—primarily logic errors or domain-specific flaws—remain unpreventable by the 
language choice alone \parencite{meneely2025just}.
