...
\chapter{Guidelines to adapt the template for the Dissertation Research Plan} % Main appendix title

\label{AppendixA} % For referencing this appendix elsewhere, use \ref{AppendixA}

The dissertation template document can be adapted for the Dissertation Research Plan report, using the following guidelines:
\begin{itemize}
\item Change “Dissertation submitted in partial fulfilment of the requirements for the Master’s degree in Critical Computing Systems Engineering” to “Dissertation Research Plan of the Master’s degree in Critical Computing Systems Engineering”.
